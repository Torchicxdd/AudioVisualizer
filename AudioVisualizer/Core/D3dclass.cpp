...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	unsigned long long stringLength; // Long long ensures a 64-bit long rather than 32-bit
	...
	// We set this up so we have control over how the polygons rather than just use the default (these are still default values)
